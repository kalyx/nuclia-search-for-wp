...
* [Development and support] (https://github.com/kalyx/wp-nucliadb)
...
4. **Click** on the new menu item "Nuclia Search" and enter your API keys
...
Yes, you can, put only the first one in the DOM will work.
