...
class Nuclia_Admin_Page_Settings {
	...
	public function zone_callback() {
		...
		<p class="description" id="home-description"><?php esc_html_e( 'Your Nuclia Zone. Default: europe-1', 'klx-nuclia-search-for-wp' ); ?></p>
	...
	public function token_callback() {
		...
		<p class="description" id="home-description"><?php esc_html_e( 'Your Nuclia Service Access token with Contributor access (kept private).', 'klx-nuclia-search-for-wp' ); ?></p>
	...
	public function kbid_callback() {
		...
		<p class="description" id="home-description"><?php esc_html_e( 'Your Nuclia Knowledge box UID (must be public).', 'klx-nuclia-search-for-wp' ); ?></p>
	...
	public function indexable_post_types_callback() {
        ...
        <p><strong><span class="dashicons dashicons-saved" style="color:#090;"></span> <?php _e("You can start indexing your site.", 'klx-nuclia-search-for-wp' ); ?></strong></p>
